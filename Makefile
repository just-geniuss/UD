#############################################################################
# Makefile for building: UD.app/Contents/MacOS/UD
# Generated by qmake (3.1) (Qt 6.7.3)
# Project:  UD.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile UD.pro INCLUDEPATH+=/opt/homebrew/include 'LIBS+=-L/opt/homebrew/lib -lodbc'
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = UD1.0.0
DISTDIR = /Users/artempervyh/UD/.tmp/UD1.0.0
...
LIBS          = $(SUBLIBS) -F/opt/homebrew/lib -L/opt/homebrew/lib -lodbc -framework QtWidgets -framework QtGui -framework AppKit -framework ImageIO -framework Metal -framework QtSql -framework QtCore -framework IOKit -framework DiskArbitration -framework AGL -framework OpenGL   
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		UD.pro login.h \
		mainwindow.h login.cpp \
		main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = UD
DESTDIR       = 
TARGET        = UD.app/Contents/MacOS/UD
...
EXPORT__PRO_FILE_ = /Users/artempervyh/UD/UD.pro
...
UD.app/Contents/MacOS/UD: ui_login.h ui_mainwindow.h $(OBJECTS)  
	@test -d UD.app/Contents/MacOS/ || mkdir -p UD.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: UD.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile UD.pro INCLUDEPATH+=/opt/homebrew/include 'LIBS+=-L/opt/homebrew/lib -lodbc'
...
UD.app/Contents/PkgInfo: 
	@test -d UD.app/Contents || mkdir -p UD.app/Contents
	@$(DEL_FILE) UD.app/Contents/PkgInfo
	@echo "APPL????" > UD.app/Contents/PkgInfo
UD.app/Contents/Info.plist: 
	@test -d UD.app/Contents || mkdir -p UD.app/Contents
	@$(DEL_FILE) UD.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.UD,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.UD,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,UD,g" -e "s,@LIBRARY@,UD,g" -e "s,\$${EXECUTABLE_NAME},UD,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >UD.app/Contents/Info.plist

all: Makefile \
		UD.app/Contents/PkgInfo \
		UD.app/Contents/Info.plist UD.app/Contents/MacOS/UD
...
distdir: FORCE
	...
	$(COPY_FILE) --parents login.h mainwindow.h $(DISTDIR)/
	$(COPY_FILE) --parents login.cpp main.cpp mainwindow.cpp $(DISTDIR)/
	$(COPY_FILE) --parents login.ui mainwindow.ui $(DISTDIR)/
...
xcodeproj:
	@$(QMAKE) -spec macx-xcode "$(EXPORT__PRO_FILE_)" INCLUDEPATH+=/opt/homebrew/include LIBS+=-L/opt/homebrew/lib -lodbc
...
moc_login.cpp: login.h \
		...
		/opt/homebrew/include/QtSql/qsqltablemodel.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/artempervyh/UD/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/artempervyh/UD -I/opt/homebrew/include -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtSql.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib login.h -o moc_login.cpp
...
ui_login.h: login.ui \
	...
	/opt/homebrew/share/qt/libexec/uic login.ui -o ui_login.h
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/UD/bin || mkdir -p $(INSTALL_ROOT)/opt/UD/bin
	$(DEL_FILE) -r $(INSTALL_ROOT)/opt/UD/bin/UD.app
	
	$(QINSTALL) UD.app $(INSTALL_ROOT)/opt/UD/bin/UD.app
	-$(STRIP) $(INSTALL_ROOT)/opt/UD/bin/UD.app/Contents/MacOS/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/UD/bin/UD.app
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/UD/bin/ 
